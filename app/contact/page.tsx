  ...
  return <>
    <div className="contact my-5 w-[95%] mx-auto md:w-[97%] text-gray-900">
      ...
      <ul className="my-8">
        ...
        <li className="mb-7" >📍<span  className="font-semibold text-lg text-orange-950"> Address</span>
          <ul>
            <li className="ml-7">SK Edits & Crafts</li>
            <li className="ml-7">Tirunelveli, Tamilnadu - 627 001</li>
          </ul>
        </li>
        <li className="mb-7" >🕒<span className="font-semibold text-lg text-orange-950"> Business Hours</span>
          <ul>
            <li className="ml-7">Monday – Sunday: 10:00 AM – 8:00 PM</li>
            <li className="ml-7">Order Via Online </li>
          </ul>
        </li>
        <li className="mb-7">🌐 <span className="font-semibold text-lg text-orange-950">Social Media</span>
          <ul>
            ...
            className="text-orange-950 font-semibold" >Instagram</a></li>
          </ul>
        </li>
      </ul>
